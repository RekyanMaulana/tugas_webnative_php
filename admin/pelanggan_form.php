...
<form action="pelanggan_controller.php" method="POST">
      ...
      <div class="form-group row">
        ...
        <div class="col-8">
          <input id="nama" name="nama" type="text" class="form-control" value="<?= $plgn['nama'] ?>">
        </div>
      </div>
      <div class="form-group row">
      ...
      <div class="form-group row">
        ...
        <div class="col-8">
          <input id="tgl_lahir" name="tgl_lahir" type="text" class="form-control" value="<?= $plgn['tgl_lahir'] ?>">
        </div>
      </div>
      <div class="form-group row">
        <label for="text5" class="col-4 col-form-label">Email</label> 
        <div class="col-8">
          <input id="email" name="email" type="text" class="form-control" value="<?= $plgn['email'] ?>">
        </div>
      </div>
      <div class="form-group row">
        <label for="text6" class="col-4 col-form-label">Kartu Id</label> 
        <div class="col-8">
          <input id="kartu_id" name="kartu_id" type="text" class="form-control" value="<?= $plgn['kartu_id'] ?>">
        </div>
      </div> 
      <div class="form-group row">
